...
namespace DancingLineFanmade.Trigger
{
    ...
    public class TTFCheckPoint : MonoBehaviour
    {
        private Player player;

        public Transform rotator;
        private Transform checkpointGem;
        ...
        private void Start()
        {
            ...
            checkpointGem = rotator.transform.Find("CheckPoint_Gem");
        ...
        {
            player.TTFCheckPoints.Add(this);
            ...
            checkpointGem.GetComponent<TTFCheckPointGem>().PickUp(false);
