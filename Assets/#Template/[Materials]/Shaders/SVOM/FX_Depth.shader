Shader "SVOM/FX_Depth"
{
	Properties
	{
		...
		_Fading_Distance("Fading_Distance", Range( 0 , 50)) = 1
	...
	Category 
	{
		...
		LOD 0
			...
			Pass {
				...
				uniform float _Fading_Distance;
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float distanceDepth1 = abs( ( screenDepth1 - LinearEyeDepth( ase_positionSSNorm.z ) ) / ( _Fading_Distance ) );
					

					fixed4 col = ( ( tex2D( _MainTexture, uv_MainTexture ) * _Color ) * saturate( distanceDepth1 ) * i.color );
